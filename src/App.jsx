...
function Footer() {
  return (
    <footer className="bg-surface-dim dark:bg-surface-dim w-full py-6 md:py-12 border-t border-surface-variant mt-auto">
      <div className="flex flex-col md:flex-row justify-between items-center px-margin-mobile md:px-margin-desktop max-w-max-width mx-auto gap-3 md:gap-8">
        <div className="flex items-center gap-2 md:gap-3">
          <Logo size={28} className="w-5 h-5 md:w-7 md:h-7" />
          <span className="text-[1rem] md:text-display-md">
        ...
        <div className="font-body-sm text-[0.75rem] md:text-body-sm text-text-subtle">
...
function HomePage({ onNavigate }) {
  return (
    <main className="flex-grow pt-32 pb-24">
      <section className="px-margin-mobile md:px-margin-desktop max-w-max-width mx-auto mb-24 md:mb-32">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-12 lg:gap-16 items-center">
          <div className="flex flex-col gap-6 md:gap-8">
            <h1 className="text-display-md md:text-display-lg text-on-surface">
            ...
            <div className="flex flex-wrap gap-2 md:gap-4 items-center">
              <button onClick={() => onNavigate("product")} className="btn-primary-filled px-4 md:px-8 py-2 md:py-4 rounded-DEFAULT font-label-mono uppercase tracking-wider text-[0.625rem] md:text-label-mono">
                Go To Product
              </button>
              <button onClick={() => onNavigate("docs")} className="text-on-surface-variant hover:text-primary transition-colors duration-300 font-label-mono uppercase tracking-wider px-2 md:px-4 py-2 md:py-4 flex items-center gap-1.5 md:gap-2 text-[0.625rem] md:text-label-mono">
                Read Documentation <IconArrowRight className="w-3 h-3 md:w-4 md:h-4" />
              </button>
            </div>
          </div>
          <HeroVisual />
      ...
      <section className="px-margin-mobile md:px-margin-desktop max-w-max-width mx-auto mb-24 md:mb-32">
        <div className="flex flex-col items-center justify-center gap-4 md:gap-6 py-20 md:py-32">
          <span className="font-label-mono text-label-mono text-pink-neon tracking-widest uppercase">Coming Soon</span>
          <h2 className="text-display-md md:text-display-lg text-on-surface text-center">
  ...
  return (
    <main className="flex-grow pt-24 md:pt-32 pb-24">
      <div className="px-margin-mobile md:px-margin-desktop max-w-max-width mx-auto">
        <button onClick={() => onNavigate("home")} className="flex items-center gap-2 text-on-surface-variant hover:text-pink-neon transition-colors font-label-mono text-label-mono mb-8 md:mb-12">
          <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><polyline points="15 18 9 12 15 6" /></svg>
          Back to Home
        </button>
        <div className="flex flex-col items-center justify-center gap-4 md:gap-6 py-20 md:py-32">
          <span className="font-label-mono text-label-mono text-pink-neon tracking-widest uppercase">Coming Soon</span>
          <h1 className="text-display-md md:text-display-lg text-on-surface text-center">Product</h1>
          <p className="font-body-md text-body-md text-on-surface-variant max-w-md text-center">
  ...
  return (
    <main className="flex-grow pt-24 md:pt-32 pb-24">
      <div className="px-margin-mobile md:px-margin-desktop max-w-max-width mx-auto">
        ...
        <div className="flex flex-col items-center justify-center gap-4 md:gap-6 py-20 md:py-32">
          <span className="font-label-mono text-label-mono text-pink-neon tracking-widest uppercase">Coming Soon</span>
          <h1 className="text-display-md md:text-display-lg text-on-surface text-center">Documentation</h1>
          <p className="font-body-md text-body-md text-on-surface-variant max-w-md text-center">
