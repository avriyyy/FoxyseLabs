export default function HeroVisual() {
  return (
    <div className="relative w-full aspect-[2/1] sm:aspect-[3/1] md:aspect-none md:h-full lg:aspect-none lg:h-full stitch-node-glass rounded-none overflow-hidden border border-white/5 bg-surface-container-low flex flex-col">
